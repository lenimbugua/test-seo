...
<template>
  <div
    class="pr-1 py-1 bg-gradient-to-r from-green-500 via-fuchsia-900 to-green-700"
    @click="
  ...
  >
    ...
    <!-- <div
      class="absolute inset-0 bg-gradient-to-r from-[#2EC4B6] via-fuchsia-900 to-[#56CB05] mix-blend-overlay"
    ></div>
      ...
      <div class="w-full flex">
        ...
        >
          ...
          <div class="flex items-center space-x-1">
            ...
            <div>
              <button class="bg-[#56CB05] text-white p-1 px-2 rounded-md">
                Play Now
              </button>
            </div>
          </div>
