...
<template>
  <RouterLink
    class="px-2.5 py-1 bg-gradient-to-r from-sky-300 via-red-300 to-violet-500 flex items-center justify-between text-dark-purple-23 font-bold text-xs"
  ...
  >
    <div class="flex justify-between w-full items-center text-gray-950">
      ...
      <div>
        <button
          class="bg-white text-green-500 p-1 px-2 rounded-md flex space-x-1"
        >
