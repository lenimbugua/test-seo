...
import SportsGamesVertical from "./games-links/SportsGamesVertical.vue";
        ...
        <div class="flex min-h-full items-center justify-center text-center">
          ...
          >
            ...
            >
              ...
              <div class="max-h-[calc(100vh-20rem)] min-h-[20rem]  overflow-scroll w-full bg-gray-100 dark:bg-[#251F32]">
                <SportsGamesVertical/>
              </div>
            </DialogPanel>
          </TransitionChild>
