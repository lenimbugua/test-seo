...
<template>
  <div class="max-w-lg mx-auto">
    <!-- <SetupWizard :step="1" /> -->
    <div class="">
      <h3 class="text-center font-semibold text-xl text-[#56CB05]">
      ...
      <form class="max-w-lg mx-auto pb-4" @submit.prevent="handleFreeBetSubmit">
        ...
        <label class="flex items-top gap-2 mb-2"
          ...
          />
          <span class="text-xs leading-normal text-gray-400"
        ...
        <div class="px-0">
          <button
            class="inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 text-sky-50 bg-green-500 hover:text-sky-50/80 hover:bg-green-600/80 w-full"
          >
            <TheButtonSpin v-if="pending" />
            <span v-else>Claim Now</span>
          </button>
        </div>
        <h6 class="text-gray-400 py-2">
