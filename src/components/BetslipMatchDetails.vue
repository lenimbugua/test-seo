    ...
    >
      ...
      >
        ...
        <div class="space-y-1">
          ...
          <div
            class="flex space-x-2 items-center font-bold text-gray-950 dark:text-slate-50"
          >
            <div class="text-xs">
              {{ item.oddType }}
            </div>
            <div
              class="h-1.5 w-1.5 rounded-full bg-gray-950 dark:bg-slate-100"
            ></div>
            <div class="text-sm">
              {{ item.outcomeName }}
            </div>
          </div>
          <div class="text-xs font-light dark:text-slate-400">
