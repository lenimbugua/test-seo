...
import HalfTimeScore from "./HalfTimeScore.vue";
import { storeToRefs } from "pinia";
const { liveMatches, selectedCompetition } = storeToRefs(useInstantStore());
</script>
<template>
  <div class="px-4">
    <div
      class="w-full capitalize flex justify-center text-gray-600 dark:text-white/60 font-bold py-2"
    >
    ...
    <div
      ...
      :key="match.match_id"
      class="border-b py-2 dark:border-dark-purple-18"
    >
